      ...
      <div className="w-full max-w-xs space-y-4">
        <div className="flex justify-between items-end">
          <div className="space-y-1">
            <h2 className="text-slate-900 font-black text-xs uppercase tracking-[0.4em]">Sanz Store</h2>
            <p className="text-blue-600 text-[10px] font-mono uppercase tracking-widest animate-pulse">Initializing System...</p>
          </div>
          <span className="text-slate-900 font-mono text-xl font-black">{Math.round(progress)}%</span>
        </div>
