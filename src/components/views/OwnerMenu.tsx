    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white border border-slate-200 w-full max-w-4xl max-h-[90vh] rounded-[2rem] overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-white">
          {showOwnerLogin ? (
            <form onSubmit={handleOwnerLogin} className="max-w-xs mx-auto space-y-6 py-16">
              <div className="text-center mb-8">
                <p className="text-sm font-bold text-slate-500 uppercase tracking-widest">Secure Access</p>
              </div>
              ...
              <button type="submit" className="w-full h-14 bg-slate-900 hover:bg-black text-white font-black uppercase tracking-widest rounded-xl transition-all shadow-md">Login</button>
            </form>
          ) : ownerMode === 'dashboard' ? (
